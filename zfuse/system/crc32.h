...
namespace zfuse
{
    ...
    public: // Constructors & Destructor
        ...
        constexpr Crc32(uint32_t value) noexcept
            : m_Value(value)
        {
        }
...
#ifdef ZFUSE_CRC32_STRING_OPERATOR
/// <summary>
/// Compute the CRC32 of a string literal at compile time.
/// </summary>
/// <param name="str">The string literal to compute the CRC32 of.</param>
/// <param name="size">The size of the string literal.</param>
...
/// </summary>
/// <param name="str">The wide string literal to compute the CRC32 of.</param>
/// <param name="size">The size of the wide string literal.</param>
